...
def get_args_parser():
    ...
    parser.add_argument('--global_crops_scale', type=str, nargs='+', default=(0.40, 1.0),
                        help="""Scale range of the cropped image before resizing, relatively to the origin image.
        Used for large global view cropping. When disabling multi-crop (--local_crops_number 0), we
        recommand using a wider range of scale ("--global_crops_scale 0.14 1." for example)""")
    parser.add_argument('--local_crops_number', type=int, default=2,
                        help="""Number of small local views to generate. 
                        Set this parameter to 0 to disable multi-crop training. 
                        When disabling multi-crop we recommend to use "--global_crops_scale 0.14 1. """)
    parser.add_argument('--local_crops_scale', type=str, nargs='+', default=(0.05, 0.4),
                        help="""Scale range of the cropped image before resizing, relatively to the origin image.
    ...
    # Misc
    parser.add_argument('--data_path', default='dataset_debug', type=str,
    ...
    parser.add_argument('--weighted_sampler', default=False, type=bool_flag)
